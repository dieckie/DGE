...
public class SchlangenSpawner extends OpenVariable {      
    ...
    public Schlange schlange;public Eichhoernchen eichhoernchen;      
    /*      
     * spawn-Frequenz      
     */      
    int S_frequency = 230;      
    ...
    public SchlangenSpawner(Eichhoernchen eh) {      
        eichhoernchen = eh;      
    }      
      
    /**      
     * das "spawn-Interval" wird durch eine Verzoegerung(erzeugt durch S_i) reguliert.      
     */      
    public void act() {      
        S_i++;      
        if(S_i >= S_frequency) {      
